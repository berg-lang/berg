...
#[test]
fn equal_big_big2() {
    expect("1982648372164176312796419487198==99127934712648732164276347216429663").to_yield(false)
}
#[test]
fn equal_big2_big() {
    expect("99127934712648732164276347216429663==1982648372164176312796419487198").to_yield(false)
}
...
// nothing
#[test]
fn equal_nothing_nothing() {
    expect("()==()").to_yield(true)
}
#[test]
fn not_equal_nothing_nothing() {
...
// nothing/boolean
#[test]
fn equal_nothing_true() {
    expect("()==true").to_yield(false)
}
#[test]
fn equal_nothing_false() {
    expect("()==false").to_yield(false)
}
#[test]
fn equal_true_nothing() {
    expect("true==()").to_yield(false)
}
#[test]
fn equal_false_nothing() {
    expect("false==()").to_yield(false)
}
#[test]
fn not_equal_nothing_true() {
    expect("()!=true").to_yield(true)
}
#[test]
fn not_equal_nothing_false() {
    expect("()!=false").to_yield(true)
}
#[test]
fn not_equal_true_nothing() {
    expect("true!=()").to_yield(true)
}
#[test]
fn not_equal_false_nothing() {
    expect("false!=()").to_yield(true)
}
...
#[test]
fn not_equal_nothing_0() {
    expect("()!=0").to_yield(true)
}
#[test]
fn not_equal_nothing_1() {
    expect("()!=1").to_yield(true)
}
#[test]
fn not_equal_0_nothing() {
    expect("0!=()").to_yield(true)
}
#[test]
fn not_equal_1_nothing() {
    expect("1!=()").to_yield(true)
}
