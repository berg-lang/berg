...
fn nested_parent_field_access_error() {
    expect("a = { :x = { :y = 10 } }; a.x.x").to_error(NoSuchPublicField, 26..=30)
}
#[test]
fn nested_child_field_access_error() {
    expect("a = { :x = { :y = 10 } }; a.y").to_error(NoSuchPublicField, 26..=28)
}
#[test]
fn self_field_access_error() {
    expect("a = { :x = 10 }; a.a").to_error(NoSuchPublicField, 17..=19)
}
#[test]
fn no_such_field_access() {
    expect("a = { :x = 10 }; a.y").to_error(NoSuchPublicField, 17..=19)
}
#[test]
fn private_field_access() {
    expect("a = { x = 10 }; a.x").to_error(PrivateField, 16..=18)
}
#[test]
fn primitive_field_access() {
    expect("a = 10; a.x").to_error(NoSuchPublicField, 8..=10)
}
#[test]
fn parent_field_access_error() {
    expect(":x = 10; a = { y = 20 }; a.x").to_error(NoSuchPublicField, 25..=27)
}

#[test]
fn set_field() {
    expect("a = { :x }; a.x = 10; a.x").to_yield(10)
}
#[test]
fn multiple_set_field() {
    expect("a = { :x; :y }; a.x = 10; a.y = 20; a.x + a.y").to_yield(30)
}
#[test]
fn nested_set_field() {
    expect("a = { :b = { :x } }; a.b.x = 10; a.b.x").to_yield(10)
}
#[test]
fn set_no_such_field() {
    expect("a = { :x }; a.y = 20; a.y").to_error(NoSuchPublicField, 12..=14)
}
#[test]
fn private_set_field() {
    expect("a = { x = 10 }; a.x = 20; a.x").to_error(PrivateField, 16..=18)
}
#[test]
fn primitive_set_field() {
    expect("a = 10; a.x = 10; a.x").to_error(NoSuchPublicField, 8..=10)
}
#[test]
fn parent_field_set_error() {
    expect(":x = 10; a = { y = 20 }; a.x = 30; a.x").to_error(NoSuchPublicField, 25..=27)
}
