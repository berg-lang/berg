...
#[test]
fn add_error_nothing() {
    expect("1/0+()").to_error(DivideByZero, 2)
}
#[test]
fn add_nothing_error() {
    expect("()+1/0").to_error(UnsupportedOperator, 2)
}
#[test]
fn add_nothing_nothing() {
...
#[test]
fn sub_false_nothing() {
    expect("false-()").to_error(UnsupportedOperator, 5)
}
#[test]
fn sub_nothing_false() {
    expect("()-false").to_error(UnsupportedOperator, 2)
}
...
#[test]
fn sub_error_nothing() {
    expect("1/0-()").to_error(DivideByZero, 2)
}
#[test]
fn sub_nothing_error() {
    expect("()-1/0").to_error(UnsupportedOperator, 2)
}
#[test]
fn sub_nothing_nothing() {
    expect("()-()").to_error(UnsupportedOperator, 2)
}
...
#[test]
fn mul_false_nothing() {
    expect("false*()").to_error(UnsupportedOperator, 5)
}
#[test]
fn mul_nothing_false() {
    expect("()*false").to_error(UnsupportedOperator, 2)
}
...
#[test]
fn mul_error_nothing() {
    expect("(1/0)*()").to_error(DivideByZero, 3)
}
#[test]
fn mul_nothing_error() {
    expect("()*(1/0)").to_error(UnsupportedOperator, 2)
}
#[test]
fn mul_nothing_nothing() {
    expect("()*()").to_error(UnsupportedOperator, 2)
}
...
#[test]
fn div_false_nothing() {
    expect("false/()").to_error(UnsupportedOperator, 5)
}
#[test]
fn div_nothing_false() {
    expect("()/false").to_error(UnsupportedOperator, 2)
}
...
#[test]
fn div_error_nothing() {
    expect("(1/0)/()").to_error(DivideByZero, 3)
}
#[test]
fn div_nothing_error() {
    expect("()/(1/0)").to_error(UnsupportedOperator, 2)
}
#[test]
fn div_nothing_nothing() {
    expect("()/()").to_error(UnsupportedOperator, 2)
}
