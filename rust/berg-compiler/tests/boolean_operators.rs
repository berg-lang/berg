...
compiler_tests! {
    ...
    not_equal: "!1==1"             => error(BadTypeRightOperand@1) type(error),
    not_ne: "!1!=1"                => error(BadTypeRightOperand@1) type(error),
    not_greater: "!1>1"            => error(BadTypeRightOperand@1) type(error),
    not_less: "!1<1"               => error(BadTypeRightOperand@1) type(error),
    not_ge: "!1>=1"                => error(BadTypeRightOperand@1) type(error),
    not_le: "!1<=1"                => error(BadTypeRightOperand@1) type(error),
