...
compiler_tests! {
    ...
    decrement_pre_non_property:  "--1" => type(error) error(RightSideOfIncrementOrDecrementOperandMustBeIdentifier@2),
    ...
    // decrement_pre_non_property_expr:  "--(1+2)" => type(error) error(RightSideOfIncrementOrDecrementOperandMustBeIdentifier@2),
