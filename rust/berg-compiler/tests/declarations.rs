...
compiler_tests! {
    ...
    bare_declaration: ":a"               => type(error) errors(PropertyNotSet@1),
    ...
    increment_post_non_property: "1++" => type(error) error(LeftSideOfIncrementOrDecrementMustBeIdentifier@0),
    decrement_post_non_property: "1--" => type(error) error(LeftSideOfIncrementOrDecrementMustBeIdentifier@0),
    increment_pre_non_property:  "++1" => type(error) error(RightSideOfIncrementOrDecrementMustBeIdentifier@2),
    decrement_pre_non_property:  "--1" => type(error) error(RightSideOfIncrementOrDecrementMustBeIdentifier@2),
    ...
    // increment_post_non_property_expr: "(1+2)++" => type(error) error(LeftSideOfIncrementOrDecrementMustBeIdentifier@0),
    // decrement_post_non_property_expr: "(1+2)--" => type(error) error(LeftSideOfIncrementOrDecrementMustBeIdentifier@0),
    // increment_pre_non_property_expr:  "++(1+2)" => type(error) error(RightSideOfIncrementOrDecrementMustBeIdentifier@2),
    // decrement_pre_non_property_expr:  "--(1+2)" => type(error) error(RightSideOfIncrementOrDecrementMustBeIdentifier@2),
    ...
    assign_plus_undeclared:   "a += 1"      => type(nothing) errors(NoSuchProperty@0),
    assign_minus_undeclared:  "a -= 1"      => type(nothing) errors(NoSuchProperty@0),
    assign_times_undeclared:  "a *= 1"      => type(nothing) errors(NoSuchProperty@0),
    assign_divide_undeclared: "a /= 1"      => type(nothing) errors(NoSuchProperty@0),
    assign_and_undeclared:    "a &&= true"  => type(nothing) errors(NoSuchProperty@0),
    assign_or_undeclared:     "a ||= false" => type(nothing) errors(NoSuchProperty@0),
    increment_pre_undeclared: "++a"  => type(nothing) errors(NoSuchProperty@2),
    decrement_pre_undeclared: "--a"  => type(nothing) errors(NoSuchProperty@2),
    increment_post_undeclared: "a++" => type(nothing) errors(NoSuchProperty@0),
    decrement_post_undeclared: "a--" => type(nothing) errors(NoSuchProperty@0),

    assign_plus_undeclared_bad_type:   "a += true" => type(nothing) errors(NoSuchProperty@0,BadTypeRightOperand@[2-3]),
    assign_minus_undeclared_bad_type:  "a -= true" => type(nothing) errors(NoSuchProperty@0,BadTypeRightOperand@[2-3]),
    assign_times_undeclared_bad_type:  "a *= true" => type(nothing) errors(NoSuchProperty@0,BadTypeRightOperand@[2-3]),
    assign_divide_undeclared_bad_type: "a /= true" => type(nothing) errors(NoSuchProperty@0,BadTypeRightOperand@[2-3]),
    assign_and_undeclared_bad_type:    "a &&= 1"   => type(nothing) errors(NoSuchProperty@0,BadTypeRightOperand@[2-4]),
    assign_or_undeclared_bad_type:     "a ||= 2"   => type(nothing) errors(NoSuchProperty@0,BadTypeRightOperand@[2-4]),

    //
    // Test assignment to undefined values (ones that haven't been set)
    //

    assign_plus_undefined:   ":a; a += 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_minus_undefined:  ":a; a -= 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_times_undefined:  ":a; a *= 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_divide_undefined: ":a; a /= 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_and_undefined:    ":a; a &&= true"  => type(nothing) errors(PropertyNotSet@1),
    assign_or_undefined:     ":a; a ||= false" => type(nothing) errors(PropertyNotSet@1),
    increment_pre_undefined:  ":a; ++a"  => type(nothing) errors(PropertyNotSet@1),
    decrement_pre_undefined:  ":a; --a"  => type(nothing) errors(PropertyNotSet@1),
    increment_post_undefined: ":a; a++" => type(nothing) errors(PropertyNotSet@1),
    decrement_post_undefined: ":a; a--" => type(nothing) errors(PropertyNotSet@1),

    assign_plus_undefined_bad_type:   ":a; a += true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_minus_undefined_bad_type:  ":a; a -= true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_times_undefined_bad_type:  ":a; a *= true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_divide_undefined_bad_type: ":a; a /= true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_and_undefined_bad_type:    ":a; a &&= 1"   => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[6-8]),
    assign_or_undefined_bad_type:     ":a; a ||= 2"   => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[6-8]),

    //
    // Test behavior of assignment operations with declarations on the LHS
    //

    assign_plus_declaration:   ":a += 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_minus_declaration:  ":a -= 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_times_declaration:  ":a *= 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_divide_declaration: ":a /= 1"      => type(nothing) errors(PropertyNotSet@1),
    assign_and_declaration:    ":a &&= true"  => type(nothing) errors(PropertyNotSet@1),
    assign_or_declaration:     ":a ||= false" => type(nothing) errors(PropertyNotSet@1),
    increment_pre_declaration: "++:a"  => type(nothing) errors(PropertyNotSet@3),
    decrement_pre_declaration: "--:a"  => type(nothing) errors(PropertyNotSet@3),
    increment_post_declaration: ":a++" => type(nothing) errors(PropertyNotSet@1),
    decrement_post_declaration: ":a--" => type(nothing) errors(PropertyNotSet@1),

    assign_plus_declaration_bad_type:   ":a += true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[3-4]),
    assign_minus_declaration_bad_type:  ":a -= true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[3-4]),
    assign_times_declaration_bad_type:  ":a *= true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[3-4]),
    assign_divide_declaration_bad_type: ":a /= true" => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[3-4]),
    assign_and_declaration_bad_type:    ":a &&= 1"   => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[3-5]),
    assign_or_declaration_bad_type:     ":a ||= 2"   => type(nothing) errors(PropertyNotSet@1,BadTypeRightOperand@[3-5]),
    ...
    reassign_self_ref:        "a = a + 1" => type(nothing) errors(NoSuchProperty@4),
    assign_plus_self_ref:     "a += a" => type(nothing) errors(NoSuchProperty@0),
    assign_minus_self_ref:    "a -= a" => type(nothing) errors(NoSuchProperty@0),
    assign_multiply_self_ref: "a *= a" => type(nothing) errors(NoSuchProperty@0),
    assign_divide_self_ref:   "a /= a" => type(nothing) errors(NoSuchProperty@0),
    assign_and_self_ref:      "a &&= a" => type(nothing) errors(NoSuchProperty@0),
    assign_or_self_ref:       "a ||= a" => type(nothing) errors(NoSuchProperty@0),

    assign_plus_declaration_self_ref:     ":a += a" => type(nothing) errors(PropertyNotSet@1),
    assign_minus_declaration_self_ref:    ":a -= a" => type(nothing) errors(PropertyNotSet@1),
    assign_multiply_declaration_self_ref: ":a *= a" => type(nothing) errors(PropertyNotSet@1),
    assign_divide_declaration_self_ref:   ":a /= a" => type(nothing) errors(PropertyNotSet@1),
    assign_and_declaration_self_ref:      ":a &&= a" => type(nothing) errors(PropertyNotSet@1),
    assign_or_declaration_self_ref:       ":a ||= a" => type(nothing) errors(PropertyNotSet@1),
    ...
    declaration_declaration_ref:   ":a; a"           => type(error) errors(PropertyNotSet@1),
    assign_plus_declaration_ref:   ":a += 1; a"      => type(error) errors(PropertyNotSet@1),
    assign_minus_declaration_ref:  ":a -= 1; a"      => type(error) errors(PropertyNotSet@1),
    assign_times_declaration_ref:  ":a *= 1; a"      => type(error) errors(PropertyNotSet@1),
    assign_divide_declaration_ref: ":a /= 1; a"      => type(error) errors(PropertyNotSet@1),
    assign_and_declaration_ref:    ":a &&= true; a"  => type(error) errors(PropertyNotSet@1),
    assign_or_declaration_ref:     ":a ||= false; a" => type(error) errors(PropertyNotSet@1),

    assign_plus_declaration_bad_type_ref:   ":a; a += true; a" => type(error) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_minus_declaration_bad_type_ref:  ":a; a -= true; a" => type(error) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_times_declaration_bad_type_ref:  ":a; a *= true; a" => type(error) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_divide_declaration_bad_type_ref: ":a; a /= true; a" => type(error) errors(PropertyNotSet@1,BadTypeRightOperand@[6-7]),
    assign_and_declaration_bad_type_ref:    ":a; a &&= 1; a"   => type(error) errors(PropertyNotSet@1,BadTypeRightOperand@[6-8]),
    assign_or_declaration_bad_type_ref:     ":a; a ||= 2; a"   => type(error) errors(PropertyNotSet@1,BadTypeRightOperand@[6-8]),
