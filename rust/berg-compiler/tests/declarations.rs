...
compiler_tests! {
    ...
    // bare_declaration: ":a" => type(undefined),
    ...
    assign_undeclared:        "a = 1"       => type(nothing) errors(NoSuchProperty@0),
    ...
    // assign_plus_undefined:   ":a; a += 1"      => type(nothing) errors(PropertyNotSet@[0-1]),
    // assign_minus_undefined:  ":a; a -= 1"      => type(nothing) errors(PropertyNotSet@[0-1]),
    // assign_times_undefined:  ":a; a *= 1"      => type(nothing) errors(PropertyNotSet@[0-1]),
    // assign_divide_undefined: ":a; a /= 1"      => type(nothing) errors(PropertyNotSet@[0-1]),
    // assign_and_undefined:    ":a; a &&= true"  => type(nothing) errors(PropertyNotSet@[0-1]),
    // assign_or_undefined:     ":a; a ||= false" => type(nothing) errors(PropertyNotSet@[0-1]),
    // increment_pre_undefined:  ":a; ++a"  => type(nothing) errors(PropertyNotSet@[0-1]),
    // decrement_pre_undefined:  ":a; --a"  => type(nothing) errors(PropertyNotSet@[0-1]),
    ...
    // assign_divide_declaration: ":a /= 1"      => type(nothing) errors(PropertyNotSet@[0-1]),
    // assign_and_declaration:    ":a &&= true"  => type(nothing) errors(PropertyNotSet@[0-1]),
    // assign_or_declaration:     ":a ||= false" => type(nothing) errors(PropertyNotSet@[0-1]),
    // increment_pre_declaration: "++:a"  => type(nothing) errors(PropertyNotSet@[2-3]),
    // decrement_pre_declaration: "--:a"  => type(nothing) errors(PropertyNotSet@[2-3]),
    // increment_post_declaration: ":a++" => type(nothing) errors(PropertyNotSet@[0-1]),
    // decrement_post_declaration: ":a--" => type(nothing) errors(PropertyNotSet@[0-1]),

    // assign_plus_declaration_bad_type:   ":a += true" => type(nothing) errors(PropertyNotSet@[0-1],BadTypeRightOperand@[3-4]),
    // assign_minus_declaration_bad_type:  ":a -= true" => type(nothing) errors(PropertyNotSet@[0-1],BadTypeRightOperand@[3-4]),
    // assign_times_declaration_bad_type:  ":a *= true" => type(nothing) errors(PropertyNotSet@[0-1],BadTypeRightOperand@[3-4]),
    // assign_divide_declaration_bad_type: ":a /= true" => type(nothing) errors(PropertyNotSet@[0-1],BadTypeRightOperand@[3-4]),
    ...
    // assign_divide_declaration_ref: ":a /= 1; a"      => type(error) errors(PropertyNotSet@[0-1]),
