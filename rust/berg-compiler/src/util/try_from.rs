// Copied from Rust core: https://doc.rust-lang.org/src/core/convert.rs.html
// with Never type instead of !, and with //! comments turned to //, and "#[unstable]"
// and "#[stable]" commented out
